...
const icon = (type, x = 20) => {
  ...
  if (type < 4)
    ...
    return type === 4
      ? `<i style="background-image: url('https://gpack.speedtra.com/20b0b1f1/mainPage/img_ltr/hud/topBar/header/stockBar/warehouse_medium.png'); margin-right:4px; width: ${x}px; height: ${x}px; background-size: contain;"></i>`
      : `<i style="background-image: url('https://gpack.speedtra.com/20b0b1f1/mainPage/img_ltr/hud/topBar/header/stockBar/granary_medium.png');margin-right:4px; width: ${x}px; height: ${x}px; background-size: contain;"></i>`;
};
...
const PAGE = unsafeWindow?.speedtra?.Game?.currentPage;
