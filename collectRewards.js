const initRewardManager = () => {
  ...
  async function villageTaskSteps() {
    if (
      ...
      // https://ttq.x2.america.speedtra.com/tasks?t=1 - tasks for town, https://ttq.x2.america.speedtra.com/tasks?t=2 - general tasks
      //
    } else
      setTimeout(() => {
        navigateTo(1);
  ...
  //unsafeWindow.speedtra.Game.Quest.openTodoListDialog('', false);
